...
public partial class With_Sidebar : System.Web.UI.MasterPage
{
    ...
    public void BindService()
    {
        ...
        dse = objsql.GetDataset("select top 3 * from tblService where Status='1' order by newid()");
    ...
    {
        Cache.Remove("sid");
        Cache["sid"] = (sender as LinkButton).CommandArgument;
