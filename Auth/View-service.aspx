<%@ Page Title="" Language="C#" MasterPageFile="~/Auth/main.master" AutoEventWireup="true" CodeFile="View-service.aspx.cs" Inherits="Auth_View_service" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cpmain" Runat="Server">
    <div class="col-lg-12">
      <div class="up-lay griddesign">
        <div class="col-md-8">
            <h2 class="up-name">View Service</h2>
        </div>
        <div class="col-md-4 text-right">
            <asp:Button ID="btnback" runat="server" Text="Back" CssClass="btn btn-danger" 
                onclick="btnback_Click"/>
            &nbsp;<asp:Button ID="btnadd" runat="server" Text="Add Service" 
    ...
    <Columns>
            <asp:TemplateColumn >
             ...
             <asp:TemplateColumn ItemStyle-HorizontalAlign="Center">
                ...
                <ItemTemplate > 
                  <div style=" text-align:center"><img src="../uploadimage/<%#Eval("Image") %>" width="60" /></div>
                </ItemTemplate>
          ...
          <asp:TemplateColumn ItemStyle-HorizontalAlign="Center">
                ...
                <ItemTemplate > 
                  <div style=" text-align:center"><img src="../uploadimage/<%#Eval("thumb") %>" width="60" /></div>
                </ItemTemplate>
           ...
           <asp:TemplateColumn>
             ...
             <td> &nbsp;
                     <asp:ImageButton ToolTip='<%# Eval("Main").ToString() == "True" ? "Deactivate" :"Activate" %>' ImageUrl ='<%# Eval("Main").ToString() == "True" ? "images/active.jpg":"images/deactive.jpg" %>' ID="lbnmain" runat="Server" CommandName='<%# Eval("Main").ToString() == "True" ? "No":"Yes" %>' CommandArgument='<%# DataBinder.Eval(Container.DataItem,"id") %>'/>
                </td>
               </tr>
               </table>
                </ItemTemplate>
