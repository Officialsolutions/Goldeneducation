...
public partial class Auth_add_edit_contact : System.Web.UI.Page
{
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        if (cook != null && cook != "")
        {
            ...
            cmd.Parameters.AddWithValue("@frontname", txtfront.Text);
            cmd.Parameters.AddWithValue("@frontimg", imagename);
    ...
    public void BindData()
    {
        if (cook != "" && cook != null)
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                txtfront.Text = ds.Tables[0].Rows[0]["frontname"].ToString();
                img = ds.Tables[0].Rows[0]["frontimg"].ToString();
