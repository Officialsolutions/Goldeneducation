...
public partial class Auth_add_edit_achiever : System.Web.UI.Page
{
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        if (cook != null && cook != "")
        {
            SqlCommand cmd = new SqlCommand("UpdateAchiever", MyCon);
        ...
        {
            SqlCommand cmd = new SqlCommand("insertAchiever", MyCon);
    ...
    public void BindData()
    {
        if (cook != "" && cook != null)
        {
            SqlCommand cmd = new SqlCommand("AchieverByid", MyCon);
            cmd.CommandType = CommandType.StoredProcedure;
