...
public partial class Auth_view_ourdeals : System.Web.UI.Page
{
    ...
    {
        SqlCommand cmd = new SqlCommand("selectOurDeal", MyCon);
    ...
    protected void gridlist_ItemCommand(object source, DataGridCommandEventArgs e)
    {
        if (e.CommandName == "edit")
        {
            ...
            Response.Redirect("add-edit-ourdeals.aspx");
        }
        if (e.CommandName == "Activate")
        {
            string cmd1 = "update tblOurDeals set Status='1' where id=" + e.CommandArgument;
        ...
        {
            string cmd1 = "update tblOurDeals set Status='0' where id=" + e.CommandArgument;
            SqlCommand cmd = new SqlCommand(cmd1, MyCon);
            MyCon.Open();
            cmd.ExecuteNonQuery();
            MyCon.Close();
