...
public partial class Auth_add_edit_gallery : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            albumcode = Cache["Album_code"].ToString();
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        if (cook != null && cook != "")
        {
            SqlCommand cmd = new SqlCommand("UpdateGallery", MyCon);
        ...
        {
            SqlCommand cmd = new SqlCommand("insertGallery", MyCon);
            ...
            cmd.Parameters.AddWithValue("@Album_Code", albumcode);
    ...
    public void BindData()
    {
        if (cook != "" && cook != null)
        {
            SqlCommand cmd = new SqlCommand("GalleryByid", MyCon);
            cmd.CommandType = CommandType.StoredProcedure;
