<%@ Page Title="" Language="C#" MasterPageFile="~/Auth/main.master" AutoEventWireup="true" CodeFile="View-Video-album.aspx.cs" Inherits="Auth_View_Video_album" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cpmain" Runat="Server">
    <div class="col-lg-12">
      <div class="up-lay griddesign">
        <div class="col-md-8">
            <h2 class="up-name">View Video Album</h2>
        </div>
...
<asp:DataGrid ID="gridlist" runat="server" Width="100%" AutoGenerateColumns="false" 
    ...
    <Columns>
          ...
          <asp:TemplateColumn ItemStyle-HorizontalAlign="Center">
                ...
                <ItemTemplate > 
                  <div style=" text-align:center"><%#Eval("url") %></div>
                </ItemTemplate>
