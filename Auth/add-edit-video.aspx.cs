...
public partial class Auth_add_edit_video : System.Web.UI.Page
{
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        if (cook != null && cook != "")
        {
            SqlCommand cmd = new SqlCommand("UpdateVideoAlbum", MyCon);
        ...
        {
            SqlCommand cmd = new SqlCommand("insertVideoAlbum", MyCon);
        ...
        cook = "";
        Cache.Remove("Val");
        Response.Redirect("View-Video-album.aspx");
    }
    ...
    public void BindData()
    {
        if (cook != "" && cook != null)
        {
            SqlCommand cmd = new SqlCommand("VideoAlbumByid", MyCon);
            cmd.CommandType = CommandType.StoredProcedure;
