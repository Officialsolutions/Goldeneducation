...
public partial class Auth_add_edit_service : System.Web.UI.Page
{
    SqlConnection MyCon = new SqlConnection(WebConfigurationManager.ConnectionStrings["con"].ConnectionString);
    public static string imagename = "", img = "", cook = "",thumbimage="",thumb="";
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            string newpic = FileUpload1.FileName;
            thumbimage = "PH" + "_" + GenerateClassCode() + "_" + newpic;
            string filePath2 = MapPath("../uploadimage/" + thumbimage);
            Stream Buffer2 = FileUpload1.PostedFile.InputStream;
            System.Drawing.Image Image2 = System.Drawing.Image.FromStream(Buffer2);
            Bitmap bmp2 = ResizeImage(Image2, Image2.Height, Image2.Width);
            bmp2.Save(filePath2, System.Drawing.Imaging.ImageFormat.Jpeg);
        }
        ...
        if (cook != null && cook != "")
        {
            SqlCommand cmd = new SqlCommand("UpdateService", MyCon);
            ...
            cmd.Parameters.AddWithValue("@thumb", thumbimage);

            cmd.Parameters.AddWithValue("@Description", txtdes.Text);

            cmd.Parameters.AddWithValue("@Main", rdomain.SelectedValue);
        ...
        {
            SqlCommand cmd = new SqlCommand("insertService", MyCon);
        ...
        cook = "";
        Cache.Remove("Val");
        Response.Redirect("View-service.aspx");
    }
    #endregion
    #region Resize Image
    ...
    public void BindData()
    {
        if (cook != "" && cook != null)
        {
            SqlCommand cmd = new SqlCommand("ServiceByid", MyCon);
            cmd.CommandType = CommandType.StoredProcedure;
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                thumb = ds.Tables[0].Rows[0]["thumb"].ToString();
                ...
                string main=ds.Tables[0].Rows[0]["Main"].ToString();
                if (main == "True")
                {
                    rdomain.SelectedValue = "1";
                }
                else
                {
                    rdomain.SelectedValue = "0";
                }
                ds.Clear();
            }
        }
    ...
    {
        if (ddltype.SelectedItem.Text == "Migration")
        {
