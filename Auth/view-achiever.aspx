<%@ Page Title="" Language="C#" MasterPageFile="~/Auth/main.master" AutoEventWireup="true" CodeFile="view-achiever.aspx.cs" Inherits="Auth_view_achiever" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cpmain" Runat="Server">
     <div class="col-lg-12">
      <div class="up-lay griddesign">
         <div class="col-md-8">
            <h2 class="up-name">View Achiever</h2>
        </div>
        <div class="col-md-4 text-right">
            <asp:Button ID="btnback" runat="server" Text="Back" CssClass="btn btn-danger" 
                onclick="btnback_Click"/>
            &nbsp;<asp:Button ID="btnadd" runat="server" Text="Add Achiever" 
