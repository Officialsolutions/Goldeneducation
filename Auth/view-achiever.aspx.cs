...
public partial class Auth_view_achiever : System.Web.UI.Page
{
    ...
    {
        SqlCommand cmd = new SqlCommand("selectAchiever", MyCon);
    ...
    protected void gridlist_ItemCommand(object source, DataGridCommandEventArgs e)
    {
        ...
        {
            string cmd1 = "update tblAchiever set Status='1' where id=" + e.CommandArgument;
        ...
        {
            string cmd1 = "update tblAchiever set Status='0' where id=" + e.CommandArgument;
            SqlCommand cmd = new SqlCommand(cmd1, MyCon);
            MyCon.Open();
            cmd.ExecuteNonQuery();
            MyCon.Close();
