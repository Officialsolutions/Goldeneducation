<%@ Page Title="" Language="C#" MasterPageFile="~/Auth/main.master" AutoEventWireup="true" CodeFile="view-countes.aspx.cs" Inherits="Auth_view_countes" %>
...
<div class="col-lg-12">
      <div class="up-lay griddesign">
        <div class="col-md-8">
            <h2 class="up-name">View Counting</h2>
        </div>
        <div class="col-md-4 text-right">
            <asp:Button ID="btnback" runat="server" Text="Back" CssClass="btn btn-danger" 
                onclick="btnback_Click"/>
            &nbsp;<asp:Button ID="btnadd" runat="server" Text="Add Counting" 
            ...
            <asp:TemplateColumn >
             ...
             <asp:TemplateColumn ItemStyle-HorizontalAlign="Center">
              ...
              <asp:TemplateColumn ItemStyle-HorizontalAlign="Center">
                ...
                <ItemTemplate > 
                     <div style=" text-align:center"><%# Eval("StudyVisa")%></div>
                </ItemTemplate>
              ...
              <asp:TemplateColumn ItemStyle-HorizontalAlign="Center">
                ...
                <ItemTemplate > 
                     <div style=" text-align:center"><%# Eval("AirTicket")%></div>
                </ItemTemplate>
              ...
              <asp:TemplateColumn ItemStyle-HorizontalAlign="Center">
                ...
                <ItemTemplate > 
                     <div style=" text-align:center"><%# Eval("HappyClient")%></div>
                </ItemTemplate>
              ...
              <asp:TemplateColumn ItemStyle-HorizontalAlign="Center">
                ...
                <ItemTemplate > 
                     <div style=" text-align:center"><%# Eval("PrVisa")%></div>
                </ItemTemplate>
