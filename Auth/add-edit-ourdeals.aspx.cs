...
public partial class Auth_add_edit_ourdeals : System.Web.UI.Page
{
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        if (cook != null && cook != "")
        {
            SqlCommand cmd = new SqlCommand("UpdateOurDeals", MyCon);
        ...
        {
            SqlCommand cmd = new SqlCommand("insertOurDeal", MyCon);
        ...
        cook = "";
        Cache.Remove("Val");
        Response.Redirect("View-ourdeals.aspx");
    }
    #endregion
    #region Resize Image
